...
//		int[] x3 = { 0, 1 };
//		int[] y3 = { 0, 0 };
//	Polygon	poly1 = new Polygon(x3, y3, 2);
//		row.put("ID", 500);
//		row.put("Location", poly);
//		db.insertIntoTable("Makan", row);
//
...
//		arr[0]= new SQLTerm("Makan", "Location", ">=", poly1);
//		arr[1]= new SQLTerm("Makan", "Location", "<",poly);
//		arr[2]= new SQLTerm("Makan", "ID", ">=", 50);
//		String [] s = {"AND","OR"};
//		Iterator<Tuple> mm = db.selectFromTable(arr, s);
//		while(mm.hasNext()) {
...
//		h.put("Location", poly1);
//		h.put("ID", 6);
//		db.deleteFromTable("Makan", h);
//		
//		 table = (Table) (DBApp.deSerialize("Makan"));
//		table.printTable();
